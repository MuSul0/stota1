  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-700 to-blue-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center opacity-20"></div>
              ...
              <Card className="text-center h-full hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <Button variant="outline" className="mt-4 text-blue-600 border-blue-600 hover:bg-blue-50" asChild>
                    <a href="https://www.google.com/search?q=Nikolai+Transport+reviews" target="_blank" rel="noopener noreferrer">
                      Jetzt bewerten
                    </a>
                  </Button>
                </CardContent>
              ...
              <Card className="text-center h-full hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <Button variant="outline" className="mt-4 text-green-600 border-green-600 hover:bg-green-50" asChild>
                    <a href="https://www.trustpilot.com/review/nikolai-transport.de" target="_blank" rel="noopener noreferrer">
                      Jetzt bewerten
                    </a>
                  </Button>
                </CardContent>
              ...
              <Card className="text-center h-full hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <Button variant="outline" className="mt-4 text-yellow-600 border-yellow-600 hover:bg-yellow-50" asChild>
                    <a href="https://www.facebook.com/nikolaitransport" target="_blank" rel="noopener noreferrer">
                      Jetzt bewerten
                    </a>
                  </Button>
                </CardContent>
