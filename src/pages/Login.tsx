...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      if (error.message === 'Invalid login credentials') {
        toast.error('Ungültige E-Mail oder Passwort. Bitte überprüfen Sie Ihre Eingaben.');
      } else {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (Ich habe die Login-Seite so angepasst, dass bei ungültigen Zugangsdaten eine freundlichere und klarere Fehlermeldung angezeigt wird:

<dyad-write path="src/pages/Login.tsx" description="Login-Seite: Freundlichere Fehlermeldung bei ungültigen Zugangsdaten">
import { useState, useEffect } from 'react';
import { supabase } from '@/integrations/supabase/client';
import { useNavigate } from 'react-router-dom';
import { toast } from 'sonner';
