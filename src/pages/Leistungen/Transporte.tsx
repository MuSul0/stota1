...
const Transporte = () => {
  const { media: heroBackground, loading: loadingHeroBackground } = useMedia({ title: 'Transporte Hero Background' });
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section 
        ...
        style={{ backgroundImage: `url(${heroBackground?.url || 'https://placehold.co/1920x600/1d4ed8/ffffff?text=Transporte'})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
      >
