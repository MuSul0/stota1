        ...
        <TabsContent value="bildverwaltung" className="mt-6">
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              ...
              <CardDescription>Hier können Sie die Bilder für spezifische Bereiche Ihrer Webseite in Echtzeit ändern. Für die allgemeine Galerie nutzen Sie bitte die Medienverwaltung unter "Einstellungen".</CardDescription>
            </CardHeader>
            <CardContent>
              <Accordion type="single" collapsible className="w-full space-y-4">
                ...
                <AccordionItem value="leistungen" className="border border-gray-700 rounded-lg"><AccordionTrigger className="px-4 py-3 hover:no-underline">Leistungen</AccordionTrigger><AccordionContent className="p-4 space-y-4 bg-gray-900/50"><MediaUploadSlot title="Leistungen Hero Bild" description="Das Titelbild für die Haupt-Leistungsseite." type="image" pageContext="leistungen" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /><MediaUploadSlot title="Header-Bild Transporte" description="Das Titelbild für die Transport-Detailseite." type="image" pageContext="leistungen" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /><MediaUploadSlot title="Header-Bild Reinigung" description="Das Titelbild für die Reinigungs-Detailseite." type="image" pageContext="leistungen" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /><MediaUploadSlot title="Header-Bild Gartenbau" description="Das Titelbild für die Gartenbau-Detailseite." type="image" pageContext="leistungen" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /><MediaUploadSlot title="Header-Bild Entsorgung" description="Das Titelbild für die Entsorgungs-Detailseite." type="image" pageContext="leistungen" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /></AccordionContent></AccordionItem>
                <AccordionItem value="ueber-uns" className="border border-gray-700 rounded-lg"><AccordionTrigger className="px-4 py-3 hover:no-underline">Über Uns</AccordionTrigger><AccordionContent className="p-4 space-y-4 bg-gray-900/50"><MediaUploadSlot title="Team Bild" description="Ein Bild des Teams oder des Gründers auf der 'Über Uns'-Seite." type="image" pageContext="ueber-uns" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /><MediaUploadSlot title="Profilbild Nicolae Turcitu" description="Profilbild des Geschäftsführers." type="image" pageContext="ueber-uns" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /><MediaUploadSlot title="Profilbild Maria Schmidt" description="Profilbild der Teamleiterin." type="image" pageContext="ueber-uns" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /><MediaUploadSlot title="Profilbild Thomas Weber" description="Profilbild des Transport-Spezialisten." type="image" pageContext="ueber-uns" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /></AccordionContent></AccordionItem>
                <AccordionItem value="galerie" className="border border-gray-700 rounded-lg"><AccordionTrigger className="px-4 py-3 hover:no-underline">Galerie</AccordionTrigger><AccordionContent className="p-4 space-y-4 bg-gray-900/50"><MediaUploadSlot title="Galerie Hero Bild" description="Das Titelbild auf der Galerie-Seite." type="image" pageContext="galerie" allMediaItems={allMediaItems} refetchAllMedia={refetchAllMedia} /></AccordionContent></AccordionItem>
