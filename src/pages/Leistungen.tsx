            ...
            {serviceCategories.map((category, index) => (
              ...
              >
                <Link to={category.link} className="block h-full">
                  <Card className="h-full rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-400 flex flex-col md:flex-row items-center overflow-hidden border-transparent hover:border-blue-300 border-2">
