        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <Button onClick={() => navigate('/auftraege')}>Anzeigen</Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <Button onClick={() => navigate('/nachrichten')}>Anzeigen</Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <Button onClick={() => navigate('/einstellungen')}>Anzeigen</Button>
            </CardContent>
          </Card>
        </div>
      </div>
